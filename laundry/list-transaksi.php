                        ...
                        <li class="list-group-item bg-dark">
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-6">
                                    ...
                                    <h5 class="text-dark"><?=($transaksi["id_transaksi"])?></h5>
                                </div>
                                <div class="col-lg-3 col-md-6">
                                    <small class="text-info">Pelanggan</small>
                                    <h5 class="text-dark"><?=($transaksi["nama"])?></h5>
                                </div>
                                <div class="col-lg-3 col-md-6">
                                    <small class="text-info">Admin</small>
                                    <h5 class="text-dark"><?=($transaksi["nama_user"])?></h5>
                                </div>
                                <div class="col-lg-3 col-md-6">
                                    <small class="text-info">Tgl. Transaksi</small>
                                    <h5 class="text-dark"><?=($transaksi["tgl"])?></h5>
                                </div>
                            </div>
